...
# despues de tener todas las librerias del proyecto instaladas
# pip freeze > requirements.txt
# para reinstalar las lib del proyeccto
# pip3 install -r requirements.txt
# deactivate
# crear el archivo de instalacion de paquetes despues de instalar todo
...
def procesarImagen(path, name):
  ...
  for (x,y,w,h) in faces:
      ...
      # img = cv2.rectangle(img,(math.floor(x),math.floor(y)),(x+math.floor(w),y+math.floor(h)),(0,255,0),2)
      ...
      res = imutils.resize(roi_color, width)
...
# mypath = "/"
# onlyfiles = [[join(mypath, f), f] for f in listdir(mypath)]
